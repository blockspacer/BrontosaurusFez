...
namespace DL_Debug
{
	...
	public:
		...
		void ShowMessageBox(const char* aMessage, const char* aFileName, const int aLineNumber, ...);
		void ShowMessageBox(const wchar_t* aMessage, const char* aFileName, const int aLineNumber, ...);
